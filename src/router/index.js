            ...
            children: [
                {
                    ...
                    meta: {title: '数据统计', permission: true, index: 'statistics'}
                },
                {
                    path: '/home/admin',
                    name: 'admin',
                    component: resolve => require(['../components/page/system/admin.vue'], resolve),
                    meta: {title: '管理员设置', permission: true, index: 'admin'}
                },
                {
                    path: '/home/role',
                    name: 'role',
                    component: resolve => require(['../components/page/system/role.vue'], resolve),
                    meta: {title: '角色设置', permission: true, index: 'role'}
                },
                {
                    path: '/home/user',
                    name: 'user',
                    component: resolve => require(['../components/page/system/admin.vue'], resolve),
                    meta: {title: '用户管理', permission: true, index: 'user'}
                },
                {
                    path: '/home/course',
                    name: 'course',
                    component: resolve => require(['../components/page/course/course.vue'], resolve),
                    meta: {title: '课程列表', permission: true, index: 'course'}
                },
                {
                    path: '/home/order',
                    name: 'order',
                    component: resolve => require(['../components/page/system/admin.vue'], resolve),
                    meta: {title: '订单列表', permission: true, index: 'order'}
                },
                {
                    path: '/home/coach',
                    name: 'coach',
                    component: resolve => require(['../components/page/system/admin.vue'], resolve),
                    meta: {title: '教练列表', permission: true, index: 'coach'}
                },
                {
                    path: '/home/feedback',
                    name: 'feedback',
